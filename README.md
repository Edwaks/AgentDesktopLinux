...
**AgentDesktopLinux** — агентский слой TaskCapitan для настольных платформ. Продукт рассчитан на пользователи TaskCapitan и операторы платформенных задач и связывает поручения TaskCapitan с действиями на поддерживаемой рабочей платформе.

- Публичный адрес: https://taskcapitan.ru/
- Основные сущности: поручения, платформы, сеансы, шаги, подтверждения и результаты.
- Ключевые возможности: получение поручений, контекст платформы, пошаговое выполнение, подтверждение действий, возврат результата, история сеанса и контроль состояния.

## Зачем нужен продукт

Рабочий процесс редко состоит из одного действия. Пользователю приходится понимать исходную ситуацию, собирать сведения, выбирать следующий шаг, согласовывать решение и возвращаться к результату позже. AgentDesktopLinux создаёт для этого единое предметное пространство. Оно помогает не терять контекст между этапами и видеть не только отдельную карточку, но и её место в общем процессе.

Главная ценность продукта — не количество экранов, а связность работы. Поручения, платформы, сеансы, шаги, подтверждения и результаты рассматриваются как части одного пользовательского маршрута. Благодаря этому новый участник быстрее понимает состояние дела, опытный специалист тратит меньше времени на ручное сопоставление, а руководитель получает обозримую картину без пересказа каждого шага.
...
Роли Постановщик, Оператор и Контролёр результата работают с одной предметной моделью, хотя видят её с разных сторон. Единые названия объектов и состояний уменьшают двусмысленность при передаче работы. Ответственный участник может сослаться на конкретный объект и ожидаемый результат, а не пересказывать весь контекст.

## Основные разделы

Публичное описание охватывает следующие пользовательские возможности:

- **Получение поручений** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Контекст платформы** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Пошаговое выполнение** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Подтверждение действий** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Возврат результата** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **История сеанса** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
- **Контроль состояния** — отдельный аспект работы, связанный с общей моделью продукта и понятным результатом для пользователя.
